...
publishDate: 2022-08-19T14:00:00
...
services: [Développement du thème WordPress, Design, Référencement, Formation]

cover: /assets/project/maine-image-sante-cover.jpg
...
<figure>
  ![Extrait du JSON de donneés structurées et de leur validation via Schema.org sur une page du site 72mis.fr](/assets/project/maine-image-sante-structured-data.jpg)
  <figcaption>Analyse des données structurées via [Schema.org](https://validator.schema.org/#url=https%3A%2F%2F72mis.fr%2Fetablissements%2Fle-mans-pole-sante-sud-2)</figcaption>
</figure>
